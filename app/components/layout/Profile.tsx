    ...
    <div className="px-[3rem] mx-auto ">
      ...
      <div>
        <div className="pt-10">
          ...
          <div>
                <div onClick={() => logout()} className="  mid:ml-0  mt-8 scale-[1.2] font-medium w-[7rem] ml-7  transition-all duration-300 translate-x-0   text-[1rem] text-white border-2  px-5 py-1  cursor-pointer border-[orange] hover:text-[orange]  bg-[orange]   hover:bg-[white] ">
              LOG-OUT
            </div>
          </div>
