...
function NavHam() {
  ...
  return (
    <div className="overflow-x-hidden  w-full">
        <button
          onClick={() => handleClick()}
          className={active? " mid:block  translate-y-[0.3rem] translate-x-[-23rem] hidden " : " mid:block hidden translate-y-[0.3rem] "}
        >
          <Image
            src="navButton.svg"
      ...
      >
        ...
        <div className={active? '  bg-white h-[200vh] w-screen leading-[2] translate-y-[-3.8rem]   pt-10  absolute ' : " bg-white h-[100vh] w-screen leading-[2] translate-y-[-4.8rem]   pt-10  absolute " }>
          <div>
          <button
          onClick={() => handleClick()}
          className={`${
